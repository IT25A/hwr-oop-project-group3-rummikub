...
class FolgeJokerTest {
	...
	fun `Folge mit Joker am Anfang ist gueltig`() {
		...
		assertThat(folge.folgeReadOnly[0].zahl()).isEqualTo(Zahl.Fuenf)
	}
	...
	fun `Folge mit zwei Jokern am Anfang ist gueltig`() {
		...
		assertThat(folge.folgeReadOnly[1].zahl()).isEqualTo(Zahl.Sechs)
	}
	...
	fun `Joker am Ende ersetzt naechste Zahl`() {
		...
		assertThat(folge.folgeReadOnly[2].zahl()).isEqualTo(Zahl.Sieben)
	}
