...
class `30PunkteTest` {
    ...
    private val rausgekommenerSpieler = Spieler("Rausgekommener Spieler", "1", create14Steine(Stein(Farbe.Rot, Zahl.Zwei)), true)
    private val nichtRausgekommenerSpieler = Spieler("Nicht Rausgekommener Spieler", "2", create14Steine(Stein(Farbe.Rot, Zahl.Zwei)))
    ...
    companion object{
        ...
        fun verschiedeneSpieler() = listOf(
            Spieler("Rausgekommener Spieler", "1", mutableListOf(Stein(Farbe.Rot, Zahl.Zwei), Stein(Farbe.Schwarz, Zahl.Fuenf), Stein(Farbe.Blau, Zahl.Fuenf),  Stein(Farbe.Rot, Zahl.Fuenf)), true, false),
            Spieler("Nicht Rausgekommener Spieler", "2", mutableListOf(Stein(Farbe.Rot, Zahl.Zwei), Stein(Farbe.Schwarz, Zahl.Fuenf), Stein(Farbe.Blau, Zahl.Fuenf),  Stein(Farbe.Rot, Zahl.Fuenf)), false, false)
        )
    ...
    fun `Aufloesen geht wenn rausgekommen`(
        ...
        assertFalse(
            spiel.tisch.tischReadOnly.contains(kombi)
        )
    }
